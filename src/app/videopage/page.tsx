  ...
  const blogPosts = [
    {
      ...
      title:
        "Poor Dog Because of the Poor Rain [Adorable Kittens And Dogs in Vietnam] Chú Chó Đáng Thương",
      date: "3/08/2020",
    ...
    },
    {
      ...
      title:
        "Chú chó Collie lang thang lúc nửa đêm gặp được người tốt Nhận nuôi😂 | Yêu Lu Official",
      date: "18/01/2024",
    ...
    },
    {
      ...
      date: "8/09/2019",
      description:
        "Chúng mình đã tiếp nhận lại em do dưới Hải Phòng không đủ điều kiện để chữa trị. Giờ em đã lột xác hoàn toàn thành một em chó xinh đẹp...",
    ...
    },
    {
      ...
      date: "16/09/2019",
      description:
        "Thật sự đây không phải lần đầu bé bị đánh hay bé cún đầu tiên bị người chủ này bạo hành.. ",
    ...
    <div className="h-[887px] bg-[#F6F6F6]">
      <div
        className={`flex flex-col items-center justify-center pt-10 gap-3 ${
          isAnimating
            ? "animate__animated animate__fadeInLeft animate__delay-2s animate__duration-4s"
            : ""
        }`}
      >
      ...
      <div className="max-w-7xl mx-auto p-4  mt-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {blogPosts.map((post) => (
            <div
              key={post.id}
              className="bg-white rounded-lg shadow-md overflow-hidden transform transition-transform duration-300 hover:scale-110"
            >
