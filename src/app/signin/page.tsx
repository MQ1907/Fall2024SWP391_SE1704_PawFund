    ...
    <div className="flex h-screen text-center justify-center align-middle animate__animated animate__fadeIn">
      ...
      <div className="w-[50%] flex flex-col items-center justify-center animate__animated animate__fadeInRight pb-72">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-[40px] font-bold pt-[140px] animate__animated animate__fadeInDown">Sign In</h1>
          <h2 className="text-[35px] font-bold pt-5 animate__animated animate__fadeInDown animate__delay-1s">Welcome to PawFund</h2>
          {authStatus === 'failed' && <p className="text-red-500 animate__animated animate__shakeX">{error}</p>} {/* Hiển thị lỗi nếu có */}
          <div className="w-[50%] pt-[50px]">
            ...
            <div className="pt-10">
              <p className="text-[15px]">
                ...
                <a className="text-[#FFEB55] cursor-pointer px-2 animate__animated animate__fadeInUp animate__delay-4s" onClick={() => router.push('/signup')}>Sign Up</a>
              </p>
            </div>
          </div>
        </div>
